...
export function Hero() {
    return (
        <div className="w-screen h-screen relative bg-[#161B19] flex items-center justify-center flex-col px-8">
            <FlickeringGrid
                ...
                width={1600}
            />
            <h1 className="text-center text-[100px] font-Poppins text-white relative z-10">
            ...
            <button className="bg-[#1dd79b] mt-8 px-10 py-3 text-black font-Poppins font-1xl rounded-xl relative z-10">
                Track
            </button>
        </div>
    );
